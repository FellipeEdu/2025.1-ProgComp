...
def dados_cartola(ano:int):
    ...
    return ano, dicCartola

def escolher_escalacao_e_quantidades(escalacao:int):
...
def salvar_exibir_selecao(selecao_atletas:dict, ano, ordem):
    ...
    try:
        ...
        print(f'Arquivo "{strselecao_json}" salvo com sucesso!')
    except Exception as e:
        sys.exit(f'ERR0: {e}')
        return
